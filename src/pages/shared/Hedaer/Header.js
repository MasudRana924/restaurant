                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="mx-auto ">
                            <span>
                                ...
                                <input type="text" placeholder="search a product here" className="input-panel ps-5" />
                            </span>
                        </Nav>
                        <Nav>
                        ...
                        <Nav>
                          ...
                          <button className="login-btn ms-3">Log-in</button> 
                          <button className="login-btn ms-1">Sign-up</button> 
